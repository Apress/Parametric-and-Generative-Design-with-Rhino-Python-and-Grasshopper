...
namespace RhinoCodePlatform.Rhino3D.Projects.Plugin.GH
{
  public sealed class AssemblyInfo : GH_AssemblyInfo
  {
    ...
    public override Guid Id { get; } = new Guid("53ce3dd7-979e-41f8-bbbc-64ad11a1b168");

    public override string AssemblyName { get; } = "LSystem2D.Components";
    public override string AssemblyVersion { get; } = "0.1.0";
    public override string AssemblyDescription { get; } = @"2D L-System plugin that contains two components - one for rewriting strings, and the other for creating 2D non-branching polylines based on the rewritten strings.";
  ...
  {
    static readonly Guid s_projectId = new Guid("53ce3dd7-979e-41f8-bbbc-64ad11a1b168");
    ...
    public override GH_LoadingInstruction PriorityLoad()
    {
      ...
      {
        Grasshopper.Instances.ComponentServer.AddCategoryIcon("LSystem2D", icon);
      }
      Grasshopper.Instances.ComponentServer.AddCategorySymbolName("LSystem2D", "LSystem2D"[0]);
